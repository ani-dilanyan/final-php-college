...
<head>
    ...
    <title>Արմատային բաջարեղեն</title>
</head>
        ...
        <div class="row m-0 p-0 ">
            <nav aria-label="breadcrumb" class="col-md-6 col-lg-8 p-0 d-none d-md-block">
                <ol class="breadcrumb bg-white">
                    ...
                    <li class="breadcrumb-item"><a href="shop.php" class="text-success">Բանջարեղեն</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Արմատային բաջարեղեն</li>
                </ol>
            </nav>
    ...
    <div class="container-fluid" id="shop">
        ...
        <div class="container-fluid p-0 m-0">
            <div class="row">
                ...
                $sql1 = "SELECT * FROM `products` WHERE category = 'carrot'";
