        ...
        <div class="row m-0 p-0 ">
            <nav aria-label="breadcrumb" class="col-md-6 col-lg-8 p-0 d-none d-md-block">
                <ol class="breadcrumb bg-white">
                    ...
                    <li class="breadcrumb-item"><a href="shop.php" class="text-success">Bakery</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Sweets</li>
                </ol>
            </nav>
            <h6 class="col-lg-2 d-none d-xl-block py-3 px-1 text-secondary">SORT BY:</h6>
            <h6 class="col-lg-1 d-none d-xl-block py-3 px-1 text-secondary">Դասավորել ըստ:</h6>
    ...
    <div class="container-fluid" id="shop">
        ...
        <div class="container-fluid p-0 m-0">
            <div class="row">
                ...
                $sql1 = "SELECT * FROM `products` WHERE category = 'sweets'";
